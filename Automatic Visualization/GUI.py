...
import datetime
import ttk
import Automatic_Visualization_new as AV
...
class CalendarFrame(Tkinter.LabelFrame):
    def __init__(self, master):
        ...
        Tkinter.Button(self, text="1.Add dates", command=getdate).pack(in_ = top, side=Tkinter.TOP, anchor='w')
        Tkinter.Button(self, text="2.All days of week", command=self.getdays).pack(in_ = top, side=Tkinter.TOP, anchor='w')
        Tkinter.Button(self, text="3.From which buildings?", command=self.fromBld).pack(in_ = top, side=Tkinter.TOP, anchor='w')
        Tkinter.Button(self, text="4.To which buildings?", command=self.toBld).pack(in_ = top, side=Tkinter.TOP, anchor='w')

        # Checkboxes for static / mobile
        self.static = Tkinter.IntVar()
        self.mobile = Tkinter.IntVar()
