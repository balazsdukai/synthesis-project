...
Main goal: (1) Identify which entrances are used to enter and exit a building; (2) Identify movement patterns and connectivity between building entrances by sequential pattern mining.
