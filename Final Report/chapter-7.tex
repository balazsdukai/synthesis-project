...
\subsection{Initial filtering}\label{generalfiltering}
...
\subsection{Adding world state}\label{Adding world}
...
\subsection{Passing by}\label{passing by}
...
\subsection{Static and mobile devices}\label{Static and mobile devices}
