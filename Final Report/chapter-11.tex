\chapter{Indoor spatio-temporal movement patterns}\label{indoormovement}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.8]{buildingpart_all_graph.png}
\captionsetup{justification=centering}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.8]{bk_map_total.png}
\captionsetup{justification=centering}
...
displayed in \autoref{appendixB}.
