...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.8]{entrances_firstapproach.png}
	\captionsetup{justification=centering}
	\caption{Most frequently recorded APs in a movement from or to the Faculty of Architecture}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.8]{bk_aplocs1.png}
	\captionsetup{justification=centering}
...
Table x shows the individual states as a result of the pre-processing (see chapter pre-processing). The records represent the states for each mac, including the first and last recorded AP (ap_start, ap_end). 
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.8]{entrances_secondapproach.png}
	\captionsetup{justification=centering}
	\caption{Most frequently recorded APs in a movement from or to the Faculty of Architecture}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.8]{bk_aplocs2.png}
	\captionsetup{justification=centering}
	\caption{The location of the most frequently used APs that are used to record the first and/or last connection of a device in the Faculty of Architecture}
